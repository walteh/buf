...
import (
	...
	"github.com/walteh/buf/private/buf/cmd/buf/command/alpha/protoc"
	"github.com/walteh/buf/private/buf/cmd/buf/command/alpha/registry/token/tokendelete"
	"github.com/walteh/buf/private/buf/cmd/buf/command/alpha/registry/token/tokenget"
	"github.com/walteh/buf/private/buf/cmd/buf/command/alpha/registry/token/tokenlist"
	"github.com/walteh/buf/private/buf/cmd/buf/command/beta/bufpluginv1"
	"github.com/walteh/buf/private/buf/cmd/buf/command/beta/bufpluginv1beta1"
	"github.com/walteh/buf/private/buf/cmd/buf/command/beta/bufpluginv2"
	"github.com/walteh/buf/private/buf/cmd/buf/command/beta/lsp"
	"github.com/walteh/buf/private/buf/cmd/buf/command/beta/price"
	betaplugindelete "github.com/walteh/buf/private/buf/cmd/buf/command/beta/registry/plugin/plugindelete"
	betapluginpush "github.com/walteh/buf/private/buf/cmd/buf/command/beta/registry/plugin/pluginpush"
	"github.com/walteh/buf/private/buf/cmd/buf/command/beta/registry/webhook/webhookcreate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/beta/registry/webhook/webhookdelete"
	"github.com/walteh/buf/private/buf/cmd/buf/command/beta/registry/webhook/webhooklist"
	"github.com/walteh/buf/private/buf/cmd/buf/command/beta/stats"
	"github.com/walteh/buf/private/buf/cmd/buf/command/beta/studioagent"
	"github.com/walteh/buf/private/buf/cmd/buf/command/breaking"
	"github.com/walteh/buf/private/buf/cmd/buf/command/build"
	"github.com/walteh/buf/private/buf/cmd/buf/command/config/configinit"
	"github.com/walteh/buf/private/buf/cmd/buf/command/config/configlsbreakingrules"
	"github.com/walteh/buf/private/buf/cmd/buf/command/config/configlslintrules"
	"github.com/walteh/buf/private/buf/cmd/buf/command/config/configlsmodules"
	"github.com/walteh/buf/private/buf/cmd/buf/command/config/configmigrate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/convert"
	"github.com/walteh/buf/private/buf/cmd/buf/command/curl"
	"github.com/walteh/buf/private/buf/cmd/buf/command/dep/depgraph"
	"github.com/walteh/buf/private/buf/cmd/buf/command/dep/depprune"
	"github.com/walteh/buf/private/buf/cmd/buf/command/dep/depupdate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/export"
	"github.com/walteh/buf/private/buf/cmd/buf/command/format"
	"github.com/walteh/buf/private/buf/cmd/buf/command/generate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/lint"
	"github.com/walteh/buf/private/buf/cmd/buf/command/lsfiles"
	"github.com/walteh/buf/private/buf/cmd/buf/command/mod/modlsbreakingrules"
	"github.com/walteh/buf/private/buf/cmd/buf/command/mod/modlslintrules"
	"github.com/walteh/buf/private/buf/cmd/buf/command/mod/modopen"
	"github.com/walteh/buf/private/buf/cmd/buf/command/plugin/pluginprune"
	"github.com/walteh/buf/private/buf/cmd/buf/command/plugin/pluginpush"
	"github.com/walteh/buf/private/buf/cmd/buf/command/plugin/pluginupdate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/push"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/modulecommit/modulecommitaddlabel"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/modulecommit/modulecommitinfo"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/modulecommit/modulecommitlist"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/modulecommit/modulecommitresolve"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/modulecreate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/moduledelete"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/moduledeprecate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/moduleinfo"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/modulelabel/modulelabelarchive"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/modulelabel/modulelabelinfo"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/modulelabel/modulelabellist"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/modulelabel/modulelabelunarchive"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/modulesettings/modulesettingsupdate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/module/moduleundeprecate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/organization/organizationcreate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/organization/organizationdelete"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/organization/organizationinfo"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/organization/organizationupdate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/plugincommit/plugincommitaddlabel"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/plugincommit/plugincommitinfo"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/plugincommit/plugincommitlist"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/plugincommit/plugincommitresolve"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/plugincreate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/plugindelete"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/plugininfo"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/pluginlabel/pluginlabelarchive"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/pluginlabel/pluginlabelinfo"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/pluginlabel/pluginlabellist"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/pluginlabel/pluginlabelunarchive"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/plugin/pluginsettings/pluginsettingsupdate"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/registrycc"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/registrylogin"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/registrylogout"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/sdk/version"
	"github.com/walteh/buf/private/buf/cmd/buf/command/registry/whoami"
	"github.com/walteh/buf/private/bufpkg/bufcobra"
	...
	if isSysError {
		err = fmt.Errorf(
			"it looks like you have found a bug in buf. "+
				"Please file an issue at https://github.com/walteh/buf/issues "+
